  ...
  return (
    <section id="galeria" className="section-padding bg-ice text-ink">
      <div className="site-container">
        ...
        <div className="mt-14 grid auto-rows-[190px] grid-cols-2 gap-3 md:auto-rows-[250px] md:grid-cols-12">
          {galleryImages.map((image, index) => (
            <MotionReveal key={image.src} delay={index * 0.05} className={`group relative overflow-hidden ${gridClasses[index]}`}>
              <Image
                src={image.src}
                alt={image.alt}
                fill
